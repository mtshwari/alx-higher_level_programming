...
I learned about how to use object-relational mapping for database scripting.I also
learned using MySQLdb and SQLAlchemy to query, create, edit, and delete tables in MySQL.
